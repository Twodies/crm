...
public class RepositoryUser {
    ...
    public LiveData<List<EntityUserInfo>> getAllUsers(String searchText) {
    ...
    public void searchUsersByName(String text) {
        Log.e(TAG, "searchUsersByName: " + text);
        if (!Objects.equals(text, "")) {
            allUsers = userDao.searchUsersByName(text);
        } else {
            allUsers = userDao.getUsers();
        }
    }
